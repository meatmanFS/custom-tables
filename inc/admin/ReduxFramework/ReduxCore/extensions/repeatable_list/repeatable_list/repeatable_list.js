    ...
    redux.field_objects.repeatable_list.init = function( selector ) {
        ...
        $( selector ).each(
            function() {
                ...
                var tpl = _this.find('.repeatable-row-template').text();
                ...
                var functions = {
                    ...
                    prepareTemplate: function() {
                        ...
                        _this.find('.repeatable-row-template').text(base64_encode(wrapper.html()));
                    ...
                    reinit: function(container) {
                        ...
                        if(container.find('textarea.wp-editor-area').length){
                            container.find('textarea.wp-editor-area').each(function(index, el) {
                                ...
                                if(prev.length){
                                    qtinit = tinyMCEPreInit.qtInit[stamp] = tinymce.extend( tinyMCEPreInit.qtInit[prev.prop('id')], false, tinyMCEPreInit.qtInit[stamp] );
                                    mceinit = tinyMCEPreInit.mceInit[stamp] = tinymce.extend( tinyMCEPreInit.mceInit[prev.prop('id')], false, tinyMCEPreInit.mceInit[stamp] );
                                } else {
                                    qtinit = tinyMCEPreInit.qtInit[stamp] = tinymce.extend( tinyMCEPreInit.qtInit.content, false, tinyMCEPreInit.qtInit[stamp] );
                                    mceinit = tinyMCEPreInit.mceInit[stamp] = tinymce.extend( tinyMCEPreInit.mceInit.content, false, tinyMCEPreInit.mceInit[stamp] );
                                }
